...
// Category drives the tile tint + grouping in the picker. Real-animal
// hybrids are grouped by what they primarily DO; mythic is its own
// rarity tier.
export type HybridCategory = 'sense' | 'move' | 'combat' | 'bio' | 'stealth' | 'mythic';
...
export interface HybridInfo {
  ...
  tagline: string;  // short preview text (max ~50 chars) shown on the picker tile
}

export const hybridCatalog: HybridInfo[] = [
  {
    id: 'echolocation', name: 'Echolocation', emoji: '🦇', category: 'sense',
    tagline: 'See in the dark with sound pings.',
    fact: 'Bats and dolphins ping the world with sound — works in darkness and under water.',
  },
  {
    id: 'wings', name: 'Wings', emoji: '🦅', category: 'move',
    tagline: 'Glide above the action (if you\'re light enough).',
  ...
  {
    id: 'venom', name: 'Venom', emoji: '🐍', category: 'combat',
    tagline: 'A bite that drops prey way bigger than you.',
    fact: 'Lets a small predator drop huge prey — a 50 g snake can take down a 100 kg deer.',
  },
  {
    id: 'electric', name: 'Electric organs', emoji: '⚡', category: 'combat',
    tagline: 'Shock attackers and stun-hunt prey.',
    fact: 'Electric eels generate ~600 volts. Producing the discharge costs about a third of the eel\'s daily energy.',
  },
  {
    id: 'camouflage', name: 'Camouflage', emoji: '🦎', category: 'stealth',
    tagline: 'Blend in — small bodies vanish best.',
    fact: 'Octopi change skin colour in ~0.3 seconds using millions of pigment cells.',
  },
  {
    id: 'antifreeze', name: 'Antifreeze blood', emoji: '🧊', category: 'bio',
    tagline: 'Move freely in sub-zero conditions.',
    fact: 'Arctic fish make sugar proteins that block ice crystals — they live in -2°C salt water.',
  },
  {
    id: 'thick-fur', name: 'Thick fur', emoji: '🦣', category: 'bio',
    tagline: 'Cold-proof insulation — best on small bodies.',
    fact: 'Musk-ox underfur is ~8× warmer per gram than sheep wool — but heavy and drag-prone.',
  },
  {
    id: 'gills', name: 'Gills', emoji: '🐟', category: 'bio',
    tagline: 'Breathe underwater indefinitely.',
    fact: 'Gills pull O₂ from water — but water carries ~30× less O₂ than air, so water flow must be much faster.',
  },
  {
    id: 'symbiosis', name: 'Symbiotic partner', emoji: '🤝', category: 'bio',
    tagline: 'Allies on call — cheaper Nest help.',
  ...
  {
    id: 'firebreath', name: 'Fire breath', emoji: '🔥', category: 'mythic',
    tagline: 'A 100°C jet attack — close-range devastation.',
  ...
  {
    id: 'stoneskin', name: 'Stone skin', emoji: '🪨', category: 'mythic',
    tagline: 'Heavy armor with no speed penalty.',
  ...
  {
    id: 'hypersonic', name: 'Hypersonic', emoji: '⚡', category: 'mythic',
    tagline: 'Beyond falcon-dive speed (small bodies only).',
    fact: 'Real top: peregrine falcon 390 km/h in a dive. Hypersonic blows past that — speed cheats the square-cube limit.',
  },
  {
    id: 'dragon', name: 'Dragon mode', emoji: '🐉', category: 'mythic',
    tagline: 'All the myths — wings, fire, scales, brain.',
  ...
  {
    id: 'photosynthesis', name: 'Photosynthesis', emoji: '🌿', category: 'bio',
    tagline: 'Gain calories from sunlight — drought-proof.',
  ...
  {
    id: 'regeneration', name: 'Regeneration', emoji: '🦎', category: 'bio',
    tagline: 'Heal wounds mid-fight (axolotl-style).',
  ...
  {
    id: 'bioluminescence', name: 'Bioluminescence', emoji: '✨', category: 'sense',
    tagline: 'Glow in the dark — dive deeper, dazzle predators.',
  ...
  {
    id: 'mimicry', name: 'Mimicry', emoji: '🎭', category: 'stealth',
    tagline: 'Shape-shift to confuse — best small.',
  ...
  {
    id: 'hibernation', name: 'Hibernation', emoji: '😴', category: 'bio',
    tagline: 'Drop your metabolism to wait out drought.',
